...
var st, x, controls, VR_mode, menu_index, walls, menu_list, state, i, j, prevStickMoved, visibility, k, move_forward, move_side, dir_vector_forward, dir_vector_side, dir_vector, move_speed, ray_cast_position, YY, raycast_result, XX;
...
for (var k_index in menu_list) {
    ...
    registerOnClick(k, false, false, [0,1,2], false, function(event) {
        ...
        for (var j_index3 in menu_list) {
            let j = menu_list[j_index3];
            changeVis(j, false);
        }
        changeVis(menu_list[menu_index], true);
    }, function(event) {});
