...
var st, VR_mode, state, prevStickMoved, visibility, move_forward, YY, move_side, XX, dir_vector_forward, dir_vector_side, dir_vector, move_speed, ray_cast_position, raycast_result;
...
st = [['GROUP', 'state_0'], ['GROUP', 'state_1']];
state = 0;
