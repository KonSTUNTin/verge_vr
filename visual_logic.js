...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getObjectUUID, initObjectPicking,
    };
};
...
registerEveryFrame(function() {
    traverseControllers(function() {
        ...
        if ((_pGlob.gamepadIndex || 0) == 1) {
            registerOnClick(getGamepadProp(xrControllerProp('GAMEPAD_INDEX'), 'AXIS', '0'), false, false, [0,1,2], false, function(event) {
