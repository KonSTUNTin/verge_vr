...
var st, x, controls, VR_mode, state, walls, prevStickMoved, i, j, visibility, move_forward, move_side, dir_vector_forward, dir_vector_side, dir_vector, YY, move_speed, XX, ray_cast_position, raycast_result;
...
st = [[['GROUP', 'logo']], [['GROUP', 'tutorial_1'], ['GROUP', 'base']], [['GROUP', 'tutorial_2'], ['GROUP', 'base'], ['GROUP', 'zone error']], [['GROUP', 'tutorial_3'], ['GROUP', 'base'], ['GROUP', 'switcher'], ['GROUP', 'zone error']], [['GROUP', 'tutorial_4'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'tutorial_5'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_2'], ['GROUP', 'zone error'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_3'], ['GROUP', 'train'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_4'], ['GROUP', 'train'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_5'], ['GROUP', 'train'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_6'], ['GROUP', 'train'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_6'], ['GROUP', 'base'], ['GROUP', 'switcher'], ['GROUP', 'only_gizmo']]];
state = 0;
