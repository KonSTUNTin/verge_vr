...
st = [[['GROUP', 'tutorial_1'], ['GROUP', 'base']], [['GROUP', 'logo']], [['GROUP', 'tutorial_2'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'tutorial_3'], ['GROUP', 'base'], ['GROUP', 'zone error'], ['GROUP', 'switcher']], [['GROUP', 'tutorial_4'], ['GROUP', 'base'], ['GROUP', 'zone error'], ['GROUP', 'switcher']], [['GROUP', 'tutorial_5'], ['GROUP', 'base'], ['GROUP', 'zone error'], ['GROUP', 'switcher'], ['GROUP', 'arrows']], [['GROUP', 'menu_1'], ['GROUP', 'zone error'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_2'], ['GROUP', 'train'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_3'], ['GROUP', 'only_gizmo'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_4'], ['GROUP', 'red_line'], ['GROUP', 'base'], ['GROUP', 'switcher'], ['GROUP', 'only_gizmo']]];
state = 0;
