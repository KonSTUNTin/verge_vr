...
var st, controls, VR_mode, state, walls, prevStickMoved, j, visibility, blue, YY, XX, move_forward, move_side, dir_vector_forward, dir_vector_side, dir_vector, move_speed, ray_cast_position, raycast_result;
...
registerEveryFrame(function() {
    traverseControllers(function() {
        if ((_pGlob.gamepadIndex || 0) == 0) {
            setObjTransform('menuu', false, 'position', getObjTransform(xrControllerProp('OBJECT'), false, 'position', 'xyz'), false);
            setObjTransform('menuu', false, 'rotation', getObjTransform(xrControllerProp('OBJECT'), false, 'rotation', 'xyz'), false);
