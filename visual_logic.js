...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        xrGetInputSource, transformCoordsSpace, transformEulerV3dToBlenderShortest, getSceneCoordSystem,
        RotationInterface, LIST_NONE, getMaterialEditableColors, initObjectPicking,
        getObjectUUID,
    };
};
...
var st, controls, VR_mode, state, walls, prevStickMoved, j, visibility, blue, YY, move_forward, XX, move_side, dir_vector_forward, dir_vector_side, dir_vector, move_speed, ray_cast_position, raycast_result;
...
st = [['GROUP', 'logo'], ['GROUP', 'tutorial'], ['GROUP', 'train'], ['GROUP', 'red_line']];
state = 0;
...
registerEveryFrame(function() {
    traverseControllers(function() {
        if ((_pGlob.gamepadIndex || 0) == 0) {
            setObjTransform('menuu', true, 'position', getObjTransform(xrControllerProp('OBJECT'), true, 'position', 'xyz'), false);
            setObjTransform('menuu', true, 'rotation', getObjTransform(xrControllerProp('OBJECT'), true, 'rotation', 'xyz'), false);
...
blue = getMaterialColor('Blue', 'Principled BSDF Color', 'RGB');
registerOnHover('hover_1', false, function(event) {
    setMaterialColor('Blue', 'Principled BSDF Color', 0.5, 0.5, 0.5, '');
}, function(event) {
    setMaterialColor('Blue', 'Principled BSDF Color', 0, 0, 0, blue);
});
...
controls = ['collider_1', 'collider_2', 'collider_3', 'collider_4'];
