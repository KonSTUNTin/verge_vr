...
this.procedures["hover_material"] = hover_material;
...
var st, x, controls, VR_mode, state, color_operative, walls, prevStickMoved, i, j, visibility, move_forward, move_side, dir_vector_forward, dir_vector_side, dir_vector, move_speed, ray_cast_position, YY, raycast_result, XX;
...
hover_material('corner_1');
hover_material('corner_2');
hover_material('corner_3');
hover_material('corner_4');
