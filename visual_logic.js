...
st = [[['GROUP', 'logo']], [['GROUP', 'tutorial_1'], ['GROUP', 'base']], [['GROUP', 'train'], ['GROUP', 'red_line'], ['GROUP', 'tutorial_2']], null, null, null];
state = 0;
...
getObjectsFrom(st, 'ALL', 'null', undefined, false);
