...
registerEveryFrame(function() {
    traverseControllers(function() {
        if ((_pGlob.gamepadIndex || 0) == 0) {
            setObjTransform('menuu', false, 'position', getObjTransform(xrControllerProp('OBJECT'), true, 'position', 'xyz'), false);
            setObjTransform('menuu', false, 'rotation', getObjTransform(xrControllerProp('OBJECT'), true, 'rotation', 'xyz'), false);
