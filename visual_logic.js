...
var st, controls, VR_mode, state, walls, prevStickMoved, j, visibility, move_forward, move_side, dir_vector_forward, dir_vector_side, dir_vector, YY, move_speed, XX, ray_cast_position, raycast_result, i;
...
st = [[['GROUP', 'logo']], [['GROUP', 'tutorial_1'], ['GROUP', 'base']], [['GROUP', 'tutorial_2'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'tutorial_3'], ['GROUP', 'base'], ['GROUP', 'zone error'], ['GROUP', 'switcher']], [['GROUP', 'tutorial_4'], ['GROUP', 'base'], ['GROUP', 'zone error'], ['GROUP', 'switcher']], [['GROUP', 'tutorial_5'], ['GROUP', 'base'], ['GROUP', 'zone error'], ['GROUP', 'switcher'], ['GROUP', 'arrows']], [['GROUP', 'menu_2'], ['GROUP', 'zone error'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_2'], ['GROUP', 'train'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_2'], ['GROUP', 'only_gizmo'], ['GROUP', 'base'], ['GROUP', 'switcher']], [['GROUP', 'menu_2'], ['GROUP', 'red_line'], ['GROUP', 'base'], ['GROUP', 'switcher'], ['GROUP', 'only_gizmo']]];
state = 0;
