...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        xrGetInputSource, transformCoordsSpace, getSceneCoordSystem, transformEulerV3dToBlenderShortest,
        RotationInterface, LIST_NONE, getObjectUUID, initObjectPicking,
    };
};
...
var st, controls, VR_mode, state, walls, prevStickMoved, j, visibility, move_forward, move_side, YY, dir_vector_forward, XX, dir_vector_side, dir_vector, move_speed, i, ray_cast_position, raycast_result;
