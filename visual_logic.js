...
var st, controls, VR_mode, state, walls, prevStickMoved, j, visibility, YY, move_forward, XX, move_side, dir_vector_forward, dir_vector_side, dir_vector, i, move_speed, ray_cast_position, raycast_result;
...
st = [[['GROUP', 'tutorial_1'], ['GROUP', 'base'], ['GROUP', 'tutorial_menu'], ['GROUP', 'arrows']], [['GROUP', 'logo']], [['GROUP', 'tutorial_2'], ['GROUP', 'base'], ['GROUP', 'arrows'], ['GROUP', 'tutorial_menu']], [['GROUP', 'tutorial_3'], ['GROUP', 'base'], ['GROUP', 'arrows'], ['GROUP', 'tutorial_menu'], ['GROUP', 'interactive_zone']], [['GROUP', 'tutorial_4'], ['GROUP', 'base'], ['GROUP', 'arrows'], ['GROUP', 'interactive_zone'], ['GROUP', 'tutorial_menu']], [['GROUP', 'tutorial_5'], ['GROUP', 'base'], ['GROUP', 'arrows'], ['GROUP', 'tutorial_menu'], ['GROUP', 'interactive_zone']], [['GROUP', 'menu_1'], ['GROUP', 'train'], ['GROUP', 'base'], ['GROUP', 'interactive_zone']], [['GROUP', 'menu_2'], null, ['GROUP', 'interactive_zone'], ['GROUP', 'base']], [['GROUP', 'menu_3'], null, ['GROUP', 'interactive_zone'], ['GROUP', 'base']], [['GROUP', 'menu_4'], ['GROUP', 'red_line'], ['GROUP', 'interactive_zone'], ['GROUP', 'base']]];
state = 0;
...
registerEveryFrame(function() {
    traverseControllers(function() {
        if ((_pGlob.gamepadIndex || 0) == 0) {
            makeParent('controller', xrControllerProp('RAY_RETICLE'));
