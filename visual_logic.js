...
var st, x, y, controls, VR_mode, state, color_operative, walls, prevStickMoved, i, j, visibility, move_forward, move_side, dir_vector_forward, dir_vector_side, dir_vector, move_speed, ray_cast_position, YY, raycast_result, XX;
...
function red_hover(y) {
    color_operative = getObjectMaterial(y, undefined, false);
