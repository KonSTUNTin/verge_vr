...
var st, VR_mode, state, prevStickMoved, visibility, move_forward, move_side, YY, dir_vector_forward, XX, dir_vector_side, dir_vector, move_speed, ray_cast_position, raycast_result;
...
st = [['GROUP', 'state_0'], ['GROUP', 'state_1'], ['GROUP', 'state_3']];
state = 0;
