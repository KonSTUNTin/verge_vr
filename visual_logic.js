    ...
    traverseControllers(function() {
        if ((_pGlob.gamepadIndex || 0) == 0) {
            ...
            if ((_pGlob.gamepadIndex || 0) == 1) {
                setObjTransform('control', false, 'position', [-(getGamepadProp(xrControllerProp('GAMEPAD_INDEX'), 'AXIS', '1') + getGamepadProp(xrControllerProp('GAMEPAD_INDEX'), 'AXIS', '3')), '', ''], true);
            }
        }
    });
});
