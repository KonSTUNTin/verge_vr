    ...
    traverseControllers(function() {
        ...
        if ((_pGlob.gamepadIndex || 0) == 1) {
            ...
            if ((Math.abs(YY) > 0.5 || Math.abs(XX) > 0.5) && !prevStickMoved) {
                ...
                if (isObjectVisible('state_0')) {
                    changeVis(getObjectsFrom('state_0', 'ALL', 'null', undefined, false), false);
                } else {
                    changeVis(getObjectsFrom('state_0', 'ALL', 'null', undefined, false), true);
                }
                prevStickMoved = true;
