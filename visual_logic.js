...
st = [['GROUP', 'logo'], ['GROUP', 'tutorial'], ['GROUP', 'base'], ['GROUP', 'train'], ['GROUP', 'highlights'], ['GROUP', 'red_line']];
state = 0;
        ...
        if ((_pGlob.gamepadIndex || 0) == 1) {
            ...
            if ((Math.abs(YY) > 0.5 || Math.abs(XX) > 0.5) && !prevStickMoved) {
                ...
                for (var i_index in st) {
                    let i = st[i_index];
                    changeVis(getObjectsFrom(i, 'ALL', 'null', undefined, false), false);
                }
